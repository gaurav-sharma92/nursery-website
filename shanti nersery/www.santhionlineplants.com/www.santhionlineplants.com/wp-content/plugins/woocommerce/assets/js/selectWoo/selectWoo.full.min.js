            ...
            return t && t.requirejs || (t ? i = t : t = {}, function(e) {
                    ...
                    s = function(e, t) {
                        var n, i, o = w(e),
                            r = o[0],
                            s = t[1];
                        return e = o[1], r && (n = _(r = m(r, s))), r ? e = n && n.normalize ? n.normalize(e, (i = s, function(e) {
                            return m(e, i)
                        })) : m(e, s) : (r = (o = w(e = m(e, s)))[0], e = o[1], r && (n = _(r))), {
                            f: r ? r + "!" + e : e,
                            n: e,
                            pr: r,
                            p: n
                        ...
                        if (m = $(o = o || t), "undefined" === x || "function" === x) {
                            ...
                            p = i ? i.apply(l[t], b) : undefined, t && (r && r.exports !== e && r.exports !== l[t] ? l[t] = r.exports : p === e && w || (l[t] = p))
                        } else t && (l[t] = i)
                    ...
                    return t.Extend(i, t.Observable), i.prototype.render = function() {
                        ...
                        var i = this,
                            o = (e.id, e.id + "-results"),
                            r = (this.options.get("minimumResultsForSearch"), Infinity, !0 === this.options.get("required"));
                        this.container = e, r && this.$selection.attr("aria-required", "true"), this.$selection.on("focus", function(e) {
                            i.trigger("focus", e)
                    ...
                    return n.Extend(o, t), o.prototype.render = function() {
                        ...
                        !0 === this.options.get("required") && this.$selection.find(".select2-selection__rendered").attr("aria-required", "true"), this.$selection.find(".select2-selection__rendered").attr("id", i).attr("role", "textbox").attr("aria-readonly", "true");
